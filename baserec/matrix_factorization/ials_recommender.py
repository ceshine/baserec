...
from baserec.base.base_matrix_factorization_recommender import BaseMatrixFactorizationRecommender
...
class IALSRecommender(BaseMatrixFactorizationRecommender, IncrementalTrainingEarlyStopping):
    """
