...
class ComputeSimilarityEuclidean:
    ...
    def __init__(self, dataMatrix, topK=100, shrink=0, normalize=False, normalize_avg_row=False,
        ...
        if similarity_from_distance_mode == "exp":
            ...
            raise ValueError("ComputeSimilarityEuclidean: value for parameter 'mode' not recognized."
        ...
        if row_weights is not None:
            ...
            if dataMatrix.shape[0] != len(row_weights):
                raise ValueError("ComputeSimilarityEuclidean: provided row_weights and dataMatrix have different number of rows."
