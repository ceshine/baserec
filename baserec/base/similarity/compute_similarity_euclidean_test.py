...
class MyTestCase(unittest.TestCase):
    ...
    def test_euclidean_similarity_integer(self):
        ...
        from baserec.base.similarity.compute_similarity_euclidean import ComputeSimilarityEuclidean
        ...
        similarity_object = ComputeSimilarityEuclidean(sps.csr_matrix(
