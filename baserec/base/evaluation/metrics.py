...
class GiniDiversity(_Global_Item_Distribution_Counter):
    """
    ...
    def __init__(self, n_items, ignore_items):
        super(GiniDiversity, self).__init__(n_items, ignore_items)
...
class DiversityHerfindahl(_Global_Item_Distribution_Counter):
    """
    ...
    def __init__(self, n_items, ignore_items):
        super(DiversityHerfindahl, self).__init__(n_items, ignore_items)
...
class ShannonEntropy(_Global_Item_Distribution_Counter):
    """
    ...
    def __init__(self, n_items, ignore_items):
        super(ShannonEntropy, self).__init__(n_items, ignore_items)
...
class DiversityMeanInterList(_Metrics_Object):
    """
    ...
    def __init__(self, n_items, cutoff):
        super(DiversityMeanInterList, self).__init__()
    ...
    def get_theoretical_max(self):
        ...
        global_co_occurrence_count = (self.n_evaluated_users*self.cutoff)**2 / \
            self.n_items - self.n_evaluated_users*self.cutoff
    ...
    def merge_with_other(self, other_metric_object):
        ...
        assert other_metric_object is DiversityMeanInterList, "Diversity_MeanInterList: attempting to merge with a metric object of different type"
