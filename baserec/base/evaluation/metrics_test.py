...
class MyTestCase(unittest.TestCase):
    ...
    def test_Gini_Index(self):
        ...
        from baserec.base.evaluation.metrics import GiniDiversity

        n_items = 1000

        gini_index = GiniDiversity(n_items, ignore_items=np.array([]))
    ...
    def test_Shannon_Entropy(self):
        ...
        from baserec.base.evaluation.metrics import ShannonEntropy

        n_items = 1000

        shannon_entropy = ShannonEntropy(n_items, ignore_items=np.array([]))
    ...
    def test_Diversity_list_all_equals(self):
        ...
        from baserec.base.evaluation.metrics import DiversityMeanInterList
        ...
        diversity_list = DiversityMeanInterList(n_items, cutoff)
        ...
        URM_predicted_sparse = sps.csr_matrix(
            (URM_predicted_data, (URM_predicted_row, URM_predicted_col)), dtype=np.int)
    ...
    def test_AUC(self):
        ...
        from baserec.base.evaluation.metrics import roc_auc
    ...
    def test_Recall(self):
        ...
        from baserec.base.evaluation.metrics import recall
    ...
    def test_Precision(self):
        ...
        from baserec.base.evaluation.metrics import precision
    ...
    def test_RR(self):
        ...
        from baserec.base.evaluation.metrics import rr
    ...
    #     # from baserec.base.evaluation.metrics import map
    ...
    def test_NDCG(self):
        ...
        from baserec.base.evaluation.metrics import dcg, ndcg
