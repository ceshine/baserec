...
from ..base.evaluation.metrics import GiniDiversity, DiversityHerfindahl, ShannonEntropy
...
def save_popularity_statistics(URM_object_list, URM_name_list, output_file_path):
    ...
    for URM_index, URM_name in enumerate(URM_name_list):
        ...
        metric_object_dict = {
            ...
            "Shannon Entropy": ShannonEntropy(n_items, ignore_items),
            "Herfindahl Index": DiversityHerfindahl(n_items, ignore_items),
        }
