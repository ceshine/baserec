...
from baserec.base.recommender_utils import check_matrix, similarityMatrixTopK
from baserec.base.incremental_training_early_stopping import IncrementalTrainingEarlyStopping

__all__ = ["SlimBprCython"]
...
class SlimBprCython(BaseItemSimilarityMatrixRecommender, IncrementalTrainingEarlyStopping):
    ...
    def fit(self, epochs=300,
        ...
        from .slim_bpr_cython_epoch import SlimBprCythonEpoch
        ...
        self.cythonEpoch = SlimBprCythonEpoch(URM_train_positive,
    ...
    #     file_to_compile_list = ['SlimBprCythonEpoch.pyx']
    ...
    #     # python compile_script.py SlimBprCythonEpoch.pyx build_ext --inplace

    #     # Command to generate html report
    #     # cython -a SlimBprCythonEpoch.pyx
