...
from .search_abstract_class import SearchAbstractClass
...
class SearchSingleCase(SearchAbstractClass):
    ...
    def _resume_from_saved(self):
        ...
        try:
            ...
            self._write_log("{}: Resuming '{}' Failed, no such file exists.".format(
                self.ALGORITHM_NAME, self.output_file_name_root))
            return False

        except Exception as e:
            self._write_log("{}: Resuming '{}' Failed, generic exception: {}.".format(
